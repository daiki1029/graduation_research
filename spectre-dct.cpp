...
int main()
{
    ...
    FILE *fp_out1 = fopen("boy_and_toys_dct_result.yuv", "wb");
    if (fp_out1 == NULL)
    {
        printf("アウトプットエラー1\n");
        return -1;
    ...
    static double dct_result[PH][PW] = { 0 };  // 画像全体のDCT結果を保持
    double dct_filter[blockSize][blockSize] = { 0 };
    static double Y2[PH][PW] = { 0 };
